			...
			<div class="form-inline">
				<div class="form-group">
					...
					<!--Modal Starts -->
				      ...
				      <button type="button" class="btn btn-info btn-lg" id="myBtn">Optimize</button>
					  <br>
					  <br>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Enhance your Point of Difference:</h4>
        </div>
        <div class="modal-body">
          <p>Point of difference refers to the factors of goods or services that establish differentiation. Differentiation is the way in which the goods or services of a company differ from its competitors. Indicators of the point of difference’s success would be increased customer benefit and brand loyalty. </p>
		  <img src="AAEAAQAAAAAAAAZWAAAAJDhlZmJkZGM5LWY2OTUtNDEzOC05N2Q5LWE3NjZiOTY1ODk2Yw.jpg" alt="Point of Difference" style="width:400px;height:350px;">
		  <p>Type your Point of Difference below</p>
           <input type="text" class="form-control transparent-input" id="pd"> 
        </div>
...
<script>
	$(document).ready(function(){
		$("#PointDiff").on('input',function(){
			$("#pd").val($("#PointDiff").val());
			});
		});
</script>
